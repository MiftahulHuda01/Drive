...
class KendaraanAdapter(val context: Context, private val itemList: MutableList<Kendaraan>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.list_kendaraan, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(context)
            .load(Utils.decodeStringtoInt(context,item.img!!))
            .into(holder.imgItem)
    ...
    interface OnItemClickListener {
        fun onItemClick(kendaraan: Kendaraan)
    }
}